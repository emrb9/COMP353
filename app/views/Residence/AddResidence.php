<?php include 'app/views/Common/header.php' ?>
    ...
    <div class="content">
        ...
        <h3 class="content-header">Add Residence</h3>
        <div class="container">
        ...
        <br>
        <div class="form-group">
          <label for="bedroomNumber">Bedrooms:</label>
          <br>
          <input type="number" name="bedroomNumber" class="form-bedroomNumber" id="bedroomNumber" placeholder="bedroomNumber" required/>
        </div>

        <button type="submit" name="action" class="create">Add Residence</button>
        <button class="cancel" onclick="window.location.href='/Residence'">Cancel</button>
    </form>
        </div>
        <!-- CONTENT END-->
